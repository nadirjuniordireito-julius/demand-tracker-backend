...
/**
 * Entidade para armazenar documentos PDF dos Termos de Abertura
 * Relacionamento 1:1 com TermoAbertura
 */
@Entity
@Table(name = "termo_abertura_doc", 
       uniqueConstraints = @UniqueConstraint(columnNames = "termo_abertura_id"))
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TermoAberturaDoc {
     ...
     */
    @OneToOne
    @JoinColumn(name = "termo_abertura_id", nullable = false, unique = true)
